    ...
    <main className="container flex flex-col items-center py-16 text-center z-[2]">
      ...
      <div className="mt-16 grid grid-cols-1 gap-4 text-left md:grid-cols-2">
        ...
        <Item href="/docs/lens">
          ...
          <h2 className="mb-2 text-lg font-semibold">Lens</h2>
          <p className="text-sm text-fd-muted-foreground">
            The React component for Data Views
          </p>
        </Item>
        <Item href="/docs/laravel">
          <Icon>
            <LibraryIcon className="size-full" />
          </Icon>
          <h2 className="mb-2 text-lg font-semibold">Laravel</h2>
          <p className="text-sm text-fd-muted-foreground">
            Locospec Backend Integration for Laravel
          </p>
        </Item>
      </div>
    </main>
